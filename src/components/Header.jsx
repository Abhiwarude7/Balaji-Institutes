...
import AdmissionForm from './AdmissionForm'; // फॉर्म कंपोनंट इम्पोर्ट करा
...
export default function Header() {
  ...
  // फॉर्म ओपन आणि क्लोज करण्यासाठी नवीन स्टेट
  ...
  return (
    <>
      <header className={`w-full bg-white font-sans transition-all duration-500 ${
        ...
        {!isSticky && (
          <div className="bg-gradient-to-r from-blue-950 via-slate-900 to-blue-950 text-white text-xs py-2.5 px-6 flex flex-col lg:flex-row justify-between items-center gap-3 border-b border-orange-500/20">
            <div className="text-gray-300 font-medium tracking-wide flex items-center gap-2">
              ...
              Balaji Institutes of Management, Pune Admissions 2026-27 Open
            </div>
              ...
              {headerData.utilityLinks.map((link, idx) => {
                ...
                return (
                  <a 
                    ...
                    href={link.href} 
                    onClick={(e) => {
                      // जर ADMISSION FORM वर क्लिक केले तर पेज स्क्रोल न करता पॉपअप दाखवा
        ...
        {/* २. ब्रँडिंग, क्विक लिंक्स आणि सोशल हँडल्स एरिया */}
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center gap-4">
          ...
          <div className="flex items-center space-x-6">
            <div className="text-xs text-gray-500 space-x-4 hidden lg:flex font-bold items-center">
              <a href="#home" className="hover:text-orange-500 transition-all hover:-translate-y-0.5">Home</a>
              <span className="text-gray-200 text-lg">/</span>
              <a href="#about-us-section" className="hover:text-orange-500 transition-all hover:-translate-y-0.5">About Us</a>
              <span className="text-gray-200 text-lg">/</span>
              <a href="tel:+911234567890" className="hover:text-orange-500 transition-all hover:-translate-y-0.5">Contact</a>
            </div>
                  ...
                  <a 
                    ...
                    onClick={(e) => {
                      if (hasDropdown && window.innerWidth < 768) {
                        ...
                        // ADMISSIONS वर क्लिक केल्यावरही फॉर्म मॉडेल ओपन होईल
                    ...
                    className={`flex items-center justify-between px-4.5 py-4 transition-all duration-300 cursor-pointer w-full md:w-auto relative uppercase border-b-2
                      ...
                      } ${isOpen ? 'border-b border-blue-900/60 text-gray-200 py-3.5 px-6' : ''}`}
                  >
      ...
      {/* ५. जेव्हा स्टेट true असेल तेव्हाच ॲडमिशन फॉर्म स्क्रीनवर दिसेल */}
